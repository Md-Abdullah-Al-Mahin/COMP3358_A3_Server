// From https://github.com/javalc6/Simple-Expression-Parser
...
public class ExpressionParser {
    ...
    private static class Node {//Node element of the binary tree
    ...
    private static class StringHolder {//helper for parsing expressions
